...
export default function OurMission() {
  return <div>
    ...
    <div class="grid grid-cols-6 pt-10 px-20 gap-4">
      <img src={sdgThree} />
      <div class="col-span-2">The park's natural environment generates positive emotions and acts as a form of ecotherapy
      ...
      <img src={sdgFour} />
      <div class="col-span-2">As our program needs to train individuals to help run the course, our project offers
    ...
    <div class="grid grid-cols-6 pt-10 px-20 gap-4">
      <img src={sdgEight} />
      <div class="col-span-2">As our program needs to train individuals to help run the course, our project offers employment
      ...
      <img src={sdgEleven} />
      <div class="col-span-2">One target that this goal aims to achieve is to provide access to safe and inclusive natural
    ...
    <div class="grid grid-cols-6 pt-10 px-20 gap-4">
      ...
      <div class="col-span-2">Our goal is to establish effective partnerships with the York University community,
        including undergraduate and graduate students. We aim to develop a program that meets their academic requirements,
        build relationships to increase involvement in the park, and network to ensure the program's sustainability for
        future expansion into different demographics. </div>
    </div>
  </div>;
}
