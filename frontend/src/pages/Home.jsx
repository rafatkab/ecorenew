      ...
      <div className="bg-white">
        <div className="font-body text-5xl flex justify-center items-center flex-col">
          ...
          <div className="italic p-8 w-2/4 text-center font-sans text-xl italics">
            Committed to fostering social resilience and connections by
            promoting inclusive student engagement through outdoor activities
        ...
        <div className="flex justify-center items-center flex-col text-3xl font-medium pb-12">
          ...
          <div className="flex justify-center">
            ...
            <div className="text-xl w-1/3 ml-10">
              ...
              opportunity to enrich their lives while honing essential soft
              skills such as communication, problem-solving, and stress
              management. Additionally, the course will play a pivotal role in
              enhancing the connection between Bruce's Mills Conservation Park
              and the local community, creating a more engaging and interactive
